...
function setupCouponStory(){
 ...
 let elapsed=0,paused=false,complete=false,visible=false,loaded=sheet.complete&&sheet.naturalWidth>0,last=0,frame=-1,phase=0;
 ...
 window.cocoObserveMotion(film,inView=>{visible=inView;last=0;refresh();});
