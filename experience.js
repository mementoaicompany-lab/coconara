...
const copy={
 ko:{couponZoom:'쿠폰 크게 보기',map:'지도에서 이름을 누르면 안내가 열려요',list:'관광지·매장 목록',steps:['쿠폰 받기','전달하기','맛보기'],captions:['코코나라 카운터에서 쿠폰 받기','달콤아재에 쿠폰 전달','아이스크림 맛보기'],pause:'멈추기',resume:'이어서 보기',replay:'다시 보기',art:'코코나라에서 나온 20% 할인 티켓이 달콤아재로 이동하고 아이스크림으로 이어지는 애니메이션',chapters:['추천 이유','직접 만든 맛','수제 마그넷','마지막 한마디'],prev:'이전 이야기',next:'다음 이야기',all:'원문 전체 펼쳐보기',one:'한 장씩 보기',end:'끝까지 읽었어요',read:'사장님의 추천 이야기'},
 en:{couponZoom:'View full coupon',map:'Tap a name on the map to open its guide',list:'Places & shops',steps:['Get coupon','Hand it over','Enjoy'],captions:['Get your coupon at the Coconara counter','Give your coupon to Dalkom Ajae','Enjoy your ice cream'],pause:'Pause',resume:'Continue',replay:'Replay',art:'A 20% discount ticket travels from Coconara to Dalkom Ajae, followed by peanut ice cream',chapters:['Why this shop','Handmade','Magnets','A last word'],prev:'Previous story',next:'Next story',all:'Read the full text',one:'Read one card at a time',end:'You’ve read it all',read:'A recommendation from the owner'},
 ms:{couponZoom:'Lihat kupon penuh',map:'Tekan nama pada peta untuk membuka panduan',list:'Tempat & kedai',steps:['Ambil kupon','Serahkan','Nikmati'],captions:['Ambil kupon di kaunter Coconara','Serahkan kupon kepada Dalkom Ajae','Nikmati aiskrim anda'],pause:'Jeda',resume:'Sambung',replay:'Main semula',art:'Tiket diskaun 20% bergerak dari Coconara ke Dalkom Ajae, diikuti aiskrim kacang',chapters:['Mengapa ini','Buatan sendiri','Magnet','Kata akhir'],prev:'Cerita sebelumnya',next:'Cerita seterusnya',all:'Baca teks penuh',one:'Baca satu kad demi satu',end:'Selesai membaca',read:'Cadangan daripada pemilik'},
 'zh-HK':{couponZoom:'查看完整優惠券',map:'點選地圖上的名稱，即可查看介紹',list:'景點及商店列表',steps:['領取優惠券','交出優惠券','享用雪糕'],captions:['在 Coconara 櫃檯領取優惠券','到 Dalkom Ajae 交出優惠券','享用美味雪糕'],pause:'暫停',resume:'繼續播放',replay:'重播',art:'八折優惠券從 Coconara 飛到 Dalkom Ajae，再呈現花生雪糕',chapters:['推薦原因','親手製作','手製磁石','最後心聲'],prev:'上一篇',next:'下一篇',all:'展開完整原文',one:'逐張閱讀',end:'已閱讀全部內容',read:'老闆的推薦故事'},
 'zh-TW':{couponZoom:'查看完整優惠券',map:'點選地圖上的名稱，即可查看介紹',list:'景點與店家列表',steps:['領取優惠券','交出優惠券','享用冰淇淋'],captions:['在 Coconara 櫃檯領取優惠券','到 Dalkom Ajae 交出優惠券','享用美味冰淇淋'],pause:'暫停',resume:'繼續播放',replay:'重播',art:'八折優惠券從 Coconara 飛到 Dalkom Ajae，再呈現花生冰淇淋',chapters:['推薦原因','親手製作','手作磁鐵','最後心聲'],prev:'上一篇',next:'下一篇',all:'展開完整原文',one:'逐張閱讀',end:'已閱讀全部內容',read:'老闆的推薦故事'},
 ja:{couponZoom:'クーポンを拡大する',map:'地図の名前をタップすると案内が開きます',list:'観光地・お店の一覧',steps:['受け取る','渡す','味わう'],captions:['Coconaraのカウンターで受け取る','Dalkom Ajaeにクーポンを渡す','アイスクリームを味わう'],pause:'一時停止',resume:'続きを見る',replay:'もう一度',art:'20%割引チケットがCoconaraからDalkom Ajaeへ移動し、ピーナッツアイスが登場するアニメーション',chapters:['おすすめの理由','手作りの味','マグネット','最後のひと言'],prev:'前の話',next:'次の話',all:'全文を開く',one:'1枚ずつ読む',end:'最後まで読みました',read:'店主のおすすめストーリー'}
};
